    ...
    return(
        <div className="flex flex-col items-center pt-5">
            {isClicked && <div className="bg-slate-700 rounded-full my-3">
                            <input value={todo} onChange={event => setTodo(event.target.value)} type="text" placeholder="Crear publicacion" className="text-2xl py-3 px-6 bg-transparent outline-none text-white"/>
                            <button onClick={addTodo} className="text-2xl py-3 px-3 rounded-full bg-orange-600 hover:bg-orange-500 transition-all font-medium">Agregar</button>
                          </div>
            }
